...
![Measure of the offline performance metrics of different algorithms on off line data and then apply a regression model to predict the CTR from those metrics](\C:\Users\dundeva\Documents\SPS\IS643assign2_pic1.png)
